...
Usage:
  python tbu_honest_boundary_reconditioning_logger.py --steps 6000 --csv run_001.csv
  python tbu_honest_boundary_reconditioning_logger.py --steps 6000 --csv run_002.csv --seed 42 --check
